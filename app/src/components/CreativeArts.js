...
import image from '../images/creative arts.jpg'

function CreativeArts(props) {
  ...
  const removetodo=(index)=>{
    axios.delete(`http://localhost:4040/creativearts/remove/${index}`)
  ...
  const addtodo=(obj)=>{
    ...
    axios.post("http://localhost:4040/creativearts/add-todo",obj)
    .then(getBirthdays())
    .catch(err=>alert(err))
    setEmptyTask(false)
  }
