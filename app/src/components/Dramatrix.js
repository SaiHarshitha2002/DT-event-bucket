...
import image from '../images/dramatrix.jpg';

function Dramatrix(props) {
  ...
  const removetodo=(index)=>{
    axios.delete(`http://localhost:4040/dramatrix/remove/${index}`)
  ...
  const addtodo=(obj)=>{
    ...
    axios.post("http://localhost:4040/dramatrix/add-todo",obj)
    .then(getBirthdays())
    .catch(err=>alert(err))
    setEmptyTask(false)
  }
